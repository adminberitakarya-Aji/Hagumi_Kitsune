...
> Tema: _**mono no aware**_ — keindahan karena segala sesuatu tidak kekal.
...
- Jalur TIDAK permanen 100%: Care Score bisa pulih pelan-pelan; Nogitsune yang dirawat baik bertahap kembali menjadi Yako→Kitsune (pesan harapan: _tidak pernah terlambat untuk memperbaiki_).
...
4. Tampilkan layar ringkasan: _"Selama kamu pergi (7 jam 20 mnt), Blobby mengantuk dan kandang kotor."_
...
1. **Balon Bicara Kontekstual** — pet mengucapkan kalimat pendek sesuai konteks:
   - Stat: _"Perutku koroong..."_ (Hunger < 30), _"Aku gatal-gatal!"_ (Hygiene < 30)
   - Waktu: pagi → sapaan, malam → mengantuk
   - Kepribadian (per elemen): Api berkata kasar-energik, Air pemalu-lembut
   - Memori: mengingat kejadian (_"Kamu lupa memberiku makan kemarin..."_)
...
_Dokumen ini adalah panduan hidup — akan diperbarui seiring playtest & keputusan desain._
